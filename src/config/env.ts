...
const envSchema = z.object({
  ...
  ADMIN_AUTH_ENABLED: z.string().optional(),
  ADMIN_AUTH_USERNAME: z.string().optional(),
  ADMIN_AUTH_PASSWORD: z.string().optional(),
  ADMIN_AUTH_BYPASS_LOCALHOST: z.string().optional(),
  ...
  AI_CROSS_PROVIDER_FALLBACK_ENABLED: z.string().optional(),
  ...
  WHATSAPP_LEGACY_ADVISOR_AUTO_ANALYZE: z.string().optional(),
  WHATSAPP_MANUAL_AI_ANALYZE_MESSAGE_LIMIT: z.coerce.number().optional(),
