...
export async function fetchOrdersForPeriod(
  ...
  const fields =
    "id,name,created_at,total_price,total_outstanding,currency,financial_status,fulfillment_status,source_name,location_id,customer,shipping_address,billing_address,payment_gateway_names,transactions,line_items";
